namespace FX.SalesLogix.Utility.UserLogins.UI
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "SalesLogix User Logins";
			// 
			// label2
			// 
			...
			this.label2.Text = "Retrieve SalesLogix user login names and passwords";
			// 
			// panel1
			// 
			...
			this.label5.Text = "Select SalesLogix Database";
			// 
			// pictureBox4
			// 
			...
			this.Text = "SalesLogix User Logins";
